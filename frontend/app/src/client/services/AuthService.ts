...
export class AuthService {
  ...
  public static authVerifyToken(): CancelablePromise<ApiResponse<any>> {
    return __request(OpenAPI, {
      method: "GET",
      url: `/auth/verify-token?timestamp=${new Date().getTime()}`,
    });
  }
   ...
   * @throws ApiError
   */
  public static authVerifyFreshToken(): CancelablePromise<
   ...
   * @throws ApiError
   */
  public static authVerifySudoToken(): CancelablePromise<
    Record<string, boolean>
  > {
    return __request(OpenAPI, {
      method: "GET",
